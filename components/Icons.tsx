...
export const ChefHatIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M12 3C12 3 8 2 8 8V14H16V8C16 2 12 3 12 3Z" />
    <path d="M8 14H16" />
    <path d="M8 17H16" />
    <path d="M8 20H16" />
  </svg>
...
export const FlameIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M12 22c-5-5-5-11 0-16 5 5 5 11 0 16z" />
...
export const ProteinIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M12.25 21.16c.54.14.75-.46.33-.81-1.7-1.4-2.82-3.44-2.82-5.71 0-1.29.35-2.59.8-3.79 1.31-3.48 4.45-6.32 8.2-7.46.2-.06.26-.35.1-.48-.19-.15-3.03-2.35-5.32-2.35-4.22 0-7.65 3.43-7.65 7.65 0 2.85 1.55 5.3 3.82 6.64.3.18.65.16.92-.04z"/>
    <path d="M15.5 8.5c.33.25.43.72.18 1.05-.25.33-.72.43-1.05.18-.33-.25-.43-.72-.18-1.05.25-.33.73-.43 1.05-.18z"/>
  </svg>
);

export const CarbsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M22 2 12 7 2 2"/>
    <path d="M12 7v14"/>
    <path d="M19.5 22c-2.43-1-3.5-3.13-3.5-6V7"/>
    <path d="M4.5 22c2.43-1 3.5-3.13 3.5-6V7"/>
  </svg>
);

export const FatIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M12 22a7 7 0 0 0 7-7c0-2-1-3.9-3-5.5s-3.5-4-3.5-6.5A3.5 3.5 0 0 0 9 6.5c0 2.6-1.5 4.9-3.5 6.5S2 13 2 15a7 7 0 0 0 7 7"/>
